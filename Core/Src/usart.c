...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
    if (huart->Instance == USART1)                    /* Èç¹ûÊÇ´®¿Ú1 */
    {
        ...
        {
            if (usart_rx_sta & 0x4000)                /* ½ÓÊÕµ½ÁË0x0d£¨¼´»Ø³µ¼ü£© */
            {
                if (rx_buffer[0] != 0x0a)             /* ½ÓÊÕµ½µÄ²»ÊÇ0x0a£¨¼´²»ÊÇ»»ÐÐ¼ü£© */
                {
                    usart_rx_sta = 0;                 /* ½ÓÊÕ´íÎó,ÖØÐÂ¿ªÊ¼ */
                }
                else                                    /* ½ÓÊÕµ½µÄÊÇ0x0a£¨¼´»»ÐÐ¼ü£© */
                {
